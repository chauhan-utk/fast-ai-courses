...
## Trying to complete the course with some of my own inputs

Might be varying the lessons a little bit so as to learn the skills that I need a little bit quickly.
